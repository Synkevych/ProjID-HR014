...
RSpec.describe ApplicationHelper, type: :helper do
  describe "#get_pages_info" do
    it "return correct number of pages for first page and 10 checklists"  do
      expect(helper.get_pages_info(1, 0)).to eq("Showing 1 to 10 of 0 entries")
    end    
    it "return correct number of pages for first page and 20 checklists"  do
      expect(helper.get_pages_info(1, 2)).to eq("Showing 1 to 10 of 2 entries")
    end
    it "return correct number of pages for second page and 20 checklists"  do
